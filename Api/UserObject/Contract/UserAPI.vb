        ...
        Public ReadOnly Property AccountsAccounts As UserObject.ApiObject.ApiObject
            Get
                If IsNothing(_AccountsAccounts) = True Then
                    _AccountsAccounts = New UserObject.ApiObject.ApiObject(UserInfo, UserObject.ApiObject.RestApi.Contract.Accounts.Accounts)
                End If
        ...
        Public ReadOnly Property MarketDepth As UserObject.ApiObject.ApiObject
            Get
                If IsNothing(_MarketDepth) = True Then
                    _MarketDepth = New UserObject.ApiObject.ApiObject(UserInfo, UserObject.ApiObject.RestApi.Contract.Market.Depth)
                End If
                Return _MarketDepth
            End Get
        End Property
        ...
        Public ReadOnly Property MarketTickers As UserObject.ApiObject.ApiObject
            Get
                If IsNothing(_MarketTickers) = True Then
                    _MarketTickers = New UserObject.ApiObject.ApiObject(UserInfo, UserObject.ApiObject.RestApi.Contract.Market.Tickers)
                End If
        ...
        Public ReadOnly Property MarketTicker As UserObject.ApiObject.ApiObject
            Get
                If IsNothing(_MarketTicker) = True Then
                    _MarketTicker = New UserObject.ApiObject.ApiObject(UserInfo, UserObject.ApiObject.RestApi.Contract.Market.Ticker)
                End If
        ...
        Public ReadOnly Property MarketContracts As UserObject.ApiObject.ApiObject
            Get
                If IsNothing(_MarketContracts) = True Then
                    _MarketContracts = New UserObject.ApiObject.ApiObject(UserInfo, UserObject.ApiObject.RestApi.Contract.Market.Contracts)
                End If
        ...
        Public ReadOnly Property MarketCandles As UserObject.ApiObject.ApiObject
            ...
            Get
                ...
                If IsNothing(_MarketCandles) = True Then
                    _MarketCandles = New UserObject.ApiObject.ApiObject(UserInfo, UserObject.ApiObject.RestApi.Contract.Market.Candles)
                End If
        ...
        Public ReadOnly Property OrderPlaceOrder As UserObject.ApiObject.ApiObject
            Get
                If IsNothing(_OrderPlaceOrder) = True Then
                    _OrderPlaceOrder = New UserObject.ApiObject.ApiObject(UserInfo, UserObject.ApiObject.RestApi.Contract.Order.PlaceOrder)
                End If
        ...
        Public ReadOnly Property OrderCancelAllOrders As UserObject.ApiObject.ApiObject
            Get
                If IsNothing(_OrderCancelAllOrders) = True Then
                    _OrderCancelAllOrders = New UserObject.ApiObject.ApiObject(UserInfo, UserObject.ApiObject.RestApi.Contract.Order.CancelAllOrders)
                End If
        ...
        Public ReadOnly Property OrderBatchOrders As UserObject.ApiObject.ApiObject
            Get
                If IsNothing(_OrderBatchOrders) = True Then
                    _OrderBatchOrders = New UserObject.ApiObject.ApiObject(UserInfo, UserObject.ApiObject.RestApi.Contract.Order.OrderBatchOrders)
                End If
        ...
        Public ReadOnly Property OrderDetail As UserObject.ApiObject.ApiObject
            Get
                If IsNothing(_OrderDetail) = True Then
                    _OrderDetail = New UserObject.ApiObject.ApiObject(UserInfo, UserObject.ApiObject.RestApi.Contract.Order.OrderDetail)
                End If
                Return _OrderDetail
            End Get
        End Property
        ...
        Public ReadOnly Property OrderCurrent As UserObject.ApiObject.ApiObject
            Get
                If IsNothing(_OrderCurrent) = True Then
                    _OrderCurrent = New UserObject.ApiObject.ApiObject(UserInfo, UserObject.ApiObject.RestApi.Contract.Order.OrderCurrent)
                End If
        ...
        Public ReadOnly Property TraceCurrentTrack As UserObject.ApiObject.ApiObject
            Get
                If IsNothing(_TraceCurrentTrack) = True Then
                    _TraceCurrentTrack = New UserObject.ApiObject.ApiObject(UserInfo, UserObject.ApiObject.RestApi.Contract.Trace.CurrentTrack)
                End If
